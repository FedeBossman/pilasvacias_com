...
if(!isset($_SESSION['last_email_sent']) || $_SESSION['last_email_sent']==null || $_SESSION['last_email_sent'] < time()){
	...
	if (isset($_POST["miencuesta"])){
		...
		mysqli_query($link,"INSERT INTO encuesta_musica (gender, age, question1, question4, question5, question6)
			VALUES ('0', '6', '$_POST[question1]', '0', '$_POST[question5]','$_POST[question6]')");
